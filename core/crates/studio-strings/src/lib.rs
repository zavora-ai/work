...
pub const CATALOGUE: &[Entry] = &[
    ...
    p(
        "settings.nothing_told_yet",
        "You have not told me anything yet.",
    ),
    p("thread.not_found", "That piece of work is not here"),
    p(
        "thread.nothing_said_yet",
        "Nothing has been said about this yet.",
    ),
    p(
        "thread.nothing_told_yet",
        "You have not told me anything about this yet.",
    ),
    p("thread.you", "you"),
    p("thread.me", "Work Studio"),
