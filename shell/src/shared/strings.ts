...
export const CATALOGUE = {
  ...
  "present.ask": p("Ask it something"),
  "present.ask_placeholder": p("What would you like to ask?"),
  "present.put_it": p("Ask"),
  "present.hold_to_ask": p("Hold to ask"),
  "present.listening": p("Listening…"),
  "present.no_microphone": p("There is no microphone on this machine, so nothing can be asked out loud."),
  "present.microphone_refused": p("Work Studio has not been allowed to hear you."),
  "deck.present": p("Present"),
  "deck.add_slide": p("Add slide"),
  "deck.copy_slide": p("Copy slide"),
  "deck.move_up": p("Move up"),
  "deck.move_down": p("Move down"),
  "deck.notes": p("What to say"),
  "deck.delete_slide": p("Delete slide"),
  "deck.notes_placeholder": p("What should be said over this slide?"),
  "deck.save_notes": p("Keep it"),
